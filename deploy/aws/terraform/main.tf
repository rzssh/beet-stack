# AWS Infrastructure for Elysia Better Auth API
terraform {
...
variable "region" {
  ...
  type        = string
  default     = "af-south-1"  # Cape Town for Africa optimization
}
...
resource "aws_ssm_parameter" "database_url" {
  ...
  type  = "SecureString"
  value = "postgresql://user:pass@host:5432/db"  # Update with actual value
...
resource "aws_ssm_parameter" "auth_secret" {
  ...
  type  = "SecureString"
  value = "change-this-secret-key-in-production"  # Update with actual value
